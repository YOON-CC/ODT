...
import type { OdtDoc, OdtBlock, Paragraph, Table, TextSpan } from './lib/odt/types'
import sampleResponse from './response.json'
import { odtJsonToHtml, type OdtJsonDocument } from './lib/odtJsonToHtml'
...
function collectBlocks(root: HTMLElement, context: ConversionContext): OdtBlock[] {
  ...
  Array.from(root.children).forEach((el) => {
    ...
    if (PARAGRAPH_TAGS.has(tag)) {
      ...
      if (p) blocks.push({ type: 'paragraph', value: p })
      return
    }
